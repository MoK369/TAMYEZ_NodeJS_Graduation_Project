...
import { AdminNotificationTypesEnum } from "../../utils/constants/enum.constants.js";
import DocumentFormat from "../../utils/formats/document.format.js";
const adminNotificationsLimitSchema = new mongoose.Schema({
    type: {
        type: String,
    ...
    careerId: {
        ...
        validate: {
            ...
            message: "careerId shouldn't have a value when type of the limit is AllUsers notifications",
        },
    },
...
adminNotificationsLimitSchema.methods.toJSON = function () {
    const adminLimit = DocumentFormat.getIdFrom_Id(this.toObject());
    return {
        id: adminLimit.id,
...
const AdminNotificationsLimitModel = mongoose.models
    .AdminNotificationsLimit ||
    mongoose.model(ModelsNames.adminNotificationsLimit, adminNotificationsLimitSchema);
