...
adminFirebaseRouter.post(RoutePaths.sendNotification, Auths.combined({
...
adminFirebaseRouter.post(RoutePaths.sendMultipleNotifications, Auths.combined({
    accessRoles: firebaseAuthorizationEndpoints.sendNotification,
}), validationMiddleware({ schema: FirebaseValidators.sendMultiNotifications }), firebaseService.sendMultipleFirebaseNotifications);
adminFirebaseRouter.post(RoutePaths.sendNotificationsToAllUsers, Auths.combined({
    accessRoles: firebaseAuthorizationEndpoints.sendNotification,
